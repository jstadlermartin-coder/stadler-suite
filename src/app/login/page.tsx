...
export default function LoginPage() {
  const { user, loading, signingIn, error, signInWithGoogle, isAuthorized } = useAuth();
  ...
  // Kein Loading-Screen mehr - zeige Login-Button sofort
          ...
          >
            {signingIn ? (
              <>
                ...
                <span className="font-medium text-slate-500">Anmeldung läuft...</span>
              </>
            ) : (
              <>
